            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            <td class="align-middle"><img src="<?php echo base_url('assets/foto_produk/' .$item['image']);?>" alt="" style="width: 100px;">
                            <?php echo $item["name"]; ?></td>
                            <td class="align-middle">Rp <?php echo number_format($item["price"], 0, ',', '.'); ?></td>
                            <td class="align-middle">
                                <?php echo $item["qty"]; ?>
                            </td>
                            <td class="align-middle">Rp <?php echo number_format ($item["price"]*$item["qty"], 0, ',', '.'); ?></td>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            <h6 class="font-weight-bold">Dikirm ke</h6>
                            <h6 class="font-weight-bold">
                            <?php 
$this->load->helper('toko');
$city = getDetailtCity($kota_tujuan);

if ($city && isset($city['rajaongkir']['results']['city_name']) && isset($city['rajaongkir']['results']['province'])) {
    echo $city['rajaongkir']['results']['city_name'] . ", " . $city['rajaongkir']['results']['province'];
} else {
    echo "Data kota tidak valid";
}
?>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <h6 class="font-weight-bold">JNE</h6>
                        </div>

                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-bold">Biaya Kurir</h6>
                            <h6 class="font-weight-bold">
                            <?php 
                            $this->load->helper('toko');
...
?>
    ...
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-k7-7SPyaBMDQAZFC"></script>
                ...
                if (data && data.length > 0) {
                    snap.pay(data, {
                        onSuccess: function(result) {
                            ...
                            $("#payment-form").submit();
                            window.location.replace("<?php echo site_url('main/finish'); ?>");
                        },
